...
Type tipoFile=(FOut,Ftype,Fdatain,Fdataout,FdataLink,FProcLink,Fnewpun,Fdisppun,
               ...
               Fsave,FNuovo,FForm,Fconferma,FControlla,FiniMem,FCaseTab,FCampoDb,FUDB,FUDBDFM,
               fcomdb,FCaseTabT,FCreaDbT,FUDataoutT,fltuttiT,FStuttiT,Ftype_C,fopen_mem,fcasetab_mem,
               fcampodb_mem);
