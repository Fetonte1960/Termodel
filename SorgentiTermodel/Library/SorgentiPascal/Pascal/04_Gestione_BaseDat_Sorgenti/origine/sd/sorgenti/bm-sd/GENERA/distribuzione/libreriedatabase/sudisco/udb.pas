...
type
  TDM1 = class(TDataModule)
            ...
            Procedure TT3NewRecord(DataSet: TDataSet);
  private
...
uses
  ...
  *)
  ...
  procedure TDM1.TT3NewRecord(DataSet: TDataSet);
  begin
    tt3.edit;
    if tt3.tablename[length(tt3.tablename)-2]='.' then
       InitDb(copy(tt3.tablename,1,length(tt3.tablename)-3))
    else InitDb(tt3.tablename)
  end;
